This is an implementation of the [Wang-Landau Algorithm](https://en.wikipedia.org/wiki/Wang_and_Landau_algorithm) for analyzing the Density of States for artificail neural networks. 
